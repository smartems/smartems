...
### Features / Enhancements
  ...
  * **CloudWatch**: Deep linking from smartEMS panel to CloudWatch console [#20279](https://github.com/grafana/grafana/issues/20279), [@sunker](https://github.com/sunker)
  * **CloudWatch**: Add smartEMS user agent to GMD calls [#20277](https://github.com/grafana/grafana/issues/20277), [@sunker](https://github.com/sunker)
...
* **smartEMS Image Renderer**: Fixes plugin page. [#19664](https://github.com/grafana/grafana/pull/19664), [@hugohaggmark](https://github.com/hugohaggmark)
...
* **AzureMonitor**: change clashing built-in smartEMS variables/macro names for Azure Logs. [#17140](https://github.com/grafana/grafana/pull/17140), [@shavonn](https://github.com/shavonn)
...
* **Explore**: Use new TimePicker from smartEMS/UI. [#17793](https://github.com/grafana/grafana/pull/17793), [@hugohaggmark](https://github.com/hugohaggmark)
...
* **HTTP Server**: Serve smartEMS with a custom URL path prefix. [#17048](https://github.com/grafana/grafana/pull/17048), [@jan25](https://github.com/jan25)
...
### Features / Enhancements
* **smartEMS-CLI**: Wrapper for `grafana-cli` within RPM/DEB packages and config/homepath are now global flags. [#17695](https://github.com/grafana/grafana/pull/17695), [@gotjosh](https://github.com/gotjosh)
...
### Bug Fixes
* **smartEMS-CLI**: Fix receiving flags via command line . [#17617](https://github.com/grafana/grafana/pull/17617), [@gotjosh](https://github.com/gotjosh)
...
* **smartEMS-CLI**: Fix receiving configuration flags from the command line. [#17606](https://github.com/grafana/grafana/pull/17606), [@gotjosh](https://github.com/gotjosh)
...
### Features / Enhancements
  ...
  * **UX**: Improve smartEMS usage for smaller screens. [#16783](https://github.com/grafana/grafana/pull/16783), [@torkelo](https://github.com/torkelo)
...
* **DataProxy**: Add custom header (X-smartEMS-User) to data source requests with the current username. [#15998](https://github.com/grafana/grafana/pull/15998), [@aocenas](https://github.com/aocenas)
...
### Minor
* **CLI**: smartEMS CLI should preserve permissions for backend binaries for Linux and Darwin [#15500](https://github.com/grafana/grafana/issues/15500)
...
* **Auth**: Replace remember me cookie solution for smartEMS's builtin, LDAP and OAuth authentication with a solution based on short-lived tokens [#15303](https://github.com/grafana/grafana/issues/15303)
...
* **Alerting**: Alert reminders deduping not working as expected when running multiple smartEMS instances [#13492](https://github.com/grafana/grafana/issues/13492)
...
* **LDAP**: Define smartEMS Admin permission in ldap group mappings [#2469](https://github.com/grafana/grafana/issues/2496), PR [#12622](https://github.com/grafana/grafana/issues/12622)
...
* **smartEMSCli**: Fixed issue with grafana-cli install plugin resulting in corrupt http response from source error. Fixes [#13079](https://github.com/grafana/grafana/issues/13079)
* **Provisioning**: Should allow one default data source per organization [#12229](https://github.com/grafana/grafana/issues/12229)
* **Github OAuth**: Allow changes of user info at Github to be synched to smartEMS when signing in [#11818](https://github.com/grafana/grafana/issues/11818), thx [@rwaweber](https://github.com/rwaweber)
...
* **UI**: Fix - smartEMS footer overlapping page [#12430](https://github.com/grafana/grafana/issues/12430)
...
* **Build**: Crosscompile and packages smartEMS on arm, windows, linux and darwin [#11920](https://github.com/grafana/grafana/pull/11920), thx [@fg2it](https://github.com/fg2it)
...
* **Docker** Can't start smartEMS on Kubernetes 1.7.14, 1.8.9, or 1.9.4 [#140 in grafana-docker repo](https://github.com/grafana/grafana-docker/issues/140) thx [@suquant](https://github.com/suquant)
...
* **Alerting** Link back to smartEMS returns wrong URL if root_path contains sub-path components [#11403](https://github.com/grafana/grafana/issues/11403)
...
# 5.0.3 (2018-03-16)
* **Mysql**: Mysql panic occurring occasionally upon smartEMS dashboard access (a bigger patch than the one in 5.0.2) [#11155](https://github.com/grafana/grafana/issues/11155)

# 5.0.2 (2018-03-14)
* **Mysql**: Mysql panic occurring occasionally upon smartEMS dashboard access [#11155](https://github.com/grafana/grafana/issues/11155)
...
- **Dashboard** Scrollbar works incorrectly in smartEMS 5.0 Beta4 in some cases [#10982](https://github.com/grafana/grafana/issues/10982)
...
* **Dashboard as cfg**: Load dashboards from file into smartEMS on startup/change [#9654](https://github.com/grafana/grafana/issues/9654) [#5269](https://github.com/grafana/grafana/issues/5269)
* **Prometheus**: smartEMS can now send alerts to Prometheus Alertmanager while firing [#7481](https://github.com/grafana/grafana/issues/7481), thx [@Thib17](https://github.com/Thib17) and [@mtanda](https://github.com/mtanda)
...
* **Backend**: Fixed bug where smartEMS exited before all sub routines where finished [#10131](https://github.com/grafana/grafana/issues/10131)
...
## Important
* **Prometheus**: Fixes bug with new prometheus alerts in smartEMS. Make sure to download this version if you're using Prometheus for alerting. More details in the issue. [#9777](https://github.com/grafana/grafana/issues/9777)
...
* **Prometheus**: Adds /metrics endpoint for exposing smartEMS metrics. [#9187](https://github.com/grafana/grafana/pull/9187)
...
* **Jaeger**: Add support for open tracing using jaeger in smartEMS. [#9213](https://github.com/grafana/grafana/pull/9213)
...
* **Graphite**: Fix for smartEMS internal metrics to Graphite sending NaN values [#9279](https://github.com/grafana/grafana/issues/9279)
...
* **smartEMSDB(mysql)**: Fix for dashboard_version.data column type, now changed to MEDIUMTEXT, fixes [#8813](https://github.com/grafana/grafana/issues/8813)
...
* **Server**: Monitoring smartEMS (health check endpoint) [#3302](https://github.com/grafana/grafana/issues/3302)
...
* **Orgs**: Sharing dashboards using smartEMS share feature will now redirect to correct org. [#1613](https://github.com/grafana/grafana/issues/1613)
...
## Minor Enhancements
* **Optimzation**: Never issue refresh event when smartEMS tab is not visible [#7218](https://github.com/grafana/grafana/issues/7218), thx [@mtanda](https://github.com/mtanda)
...
* **smartEMS-CLI**: Add default plugin path for MAC OS, fixes [#5806](https://github.com/grafana/grafana/issues/5806)
* **smartEMS-CLI**: Improve error message for upgrade-all command, fixes [#5885](https://github.com/grafana/grafana/issues/5885)
...
* **Page Footer**: Added page footer with links to docs, shows smartEMS version and info if new version is available, closes [#4889](https://github.com/grafana/grafana/pull/4889)
...
* **Page Load Crash**: A data source with null jsonData would make smartEMS fail to load page, fixes [#4536](https://github.com/grafana/grafana/issues/4536)
...
* **mysql**: smartEMS now supports ssl for mysql, closes [#3584](https://github.com/grafana/grafana/issues/3584)
* **snapshot**: Annotations are now included in snapshots, closes [#3635](https://github.com/grafana/grafana/issues/3635)
* **Admin**: Admin can now have global overview of smartEMS setup, closes [#3812](https://github.com/grafana/grafana/issues/3812)
...
- [Issue #2191](https://github.com/grafana/grafana/issues/2191). KariosDB: smartEMS now ships with a KariosDB data source plugin, thx @masaori335
...
- [Issue #1673](https://github.com/grafana/grafana/issues/1673). Basic auth: Fixed issue when using basic auth proxy infront of smartEMS
...
- Browser page title is now smartEMS - {{dashboard title}} ([Issue #294](https://github.com/grafana/grafana/issues/294))
