...
export class AnnotationsEditorCtrl {
  ...
  emptyListCta = {
    ...
    the event. You can add annotation events directly from smartems by holding CTRL or CMD + click on graph (or
    drag region). These will be stored in Grafana's annotation database.
  </p>
  Checkout the
  <a class='external-link' target='_blank' href='http://docs.smartEvo.de/reference/annotations/'
