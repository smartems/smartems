...
import { PanelProps, dateTime, DurationUnit, AnnotationEvent, AppEvents } from '@smartems/data';
import { Tooltip } from '@smartems/ui';
import { getBackendSrv } from 'app/core/services/backend_srv';
import { AbstractList } from '@smartems/ui/src/components/List/AbstractList';
...
export class AnnoListPanel extends PureComponent<Props, State> {
  ...
  async doSearch() {
    // http://docs.smartems.org/http_api/annotations/
    // https://github.com/smartems/smartems/blob/master/public/app/core/services/backend_srv.ts
    // https://github.com/smartems/smartems/blob/master/public/app/features/annotations/annotations_srv.ts
