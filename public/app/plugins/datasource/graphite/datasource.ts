...
import { DataFrame, dateMath, ScopedVars, DataQueryResponse, DataQueryRequest, toDataFrame } from '@smartems/data';
  ...
  getQueryOptionsInfo() {
    return {
      ...
      links: [
        {
          text: 'Help',
          url: 'http://docs.smartEvo.de/features/datasources/graphite/#using-graphite-in-smartems',
        },
      ],
    };
  }
