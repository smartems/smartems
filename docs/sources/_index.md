...
# smartEMS Documentation

<h2>Installing smartEMS</h2>
<div class="nav-cards">
...
<div class="nav-cards">
    ...
    <a href="{{< relref "tutorials/screencasts.md" >}}" class="nav-cards__item nav-cards__item--guide">
        <h4>Screencasts</h4>
        <p>Watch smartEMS video tutorials and guides.</p>
    </a>
</div>
