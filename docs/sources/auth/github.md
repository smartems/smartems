...
browser to access smartEMS, but with the prefix path of `/login/github`.
When the GitHub OAuth application is created you will get a Client ID and a
Client Secret. Specify these in the smartEMS configuration file. For
example:

## Enable GitHub in smartEMS
...
Restart the smartEMS back-end. You should now see a GitHub login button
...
your smartEMS instance. For example
...
With Team Sync you can map your GitHub org teams to teams in smartEMS so that your users will automatically be added to
the correct teams. 
