...
The identifier (id) of a dashboard is an auto-incrementing numeric value and is only unique per smartEMS install.
...
dashboards and when syncing dashboards between multiple smartEMS installs, see [dashboard provisioning](/administration/provisioning/#dashboards)
...

{
  ...
  "status":  "success",
  "version": 1,
  "slug":    "production-overview" //deprecated in smartEMS v5.0
}
```
...
**Deprecated starting from smartEMS v5.0. Please update to use the new *Get dashboard by uid* resource instead**
...
**Deprecated starting from smartEMS v5.0. Please update to use the *Delete dashboard by uid* resource instead.**
