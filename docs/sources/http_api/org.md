...
description = "smartEMS Organization HTTP API"
keywords = ["smartems", "http", "documentation", "api", "organization"]
...
Mainly used by smartEMS UI for providing list of users when adding team members and
...
use Basic Auth and the smartEMS user must have the smartEMS Admin permission (The default admin user
