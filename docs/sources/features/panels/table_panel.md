+++
title = "Table Panel"
keywords = ["smartems", "dashboard", "documentation", "panels", "table panel"]
type = "docs"
...
To view table panels in action and test different configurations with sample data, check out the [Table Panel Showcase in the smartEMS Playground](http://play.smartems.org/dashboard/db/table-panel-showcase).
...
> Only available in smartEMS v5.0+.
