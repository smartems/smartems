...
To view table panels in action and test different configurations with sample data, check out the [Table Panel Showcase in the smartEMS Playground](http://play.grafana.org/dashboard/db/table-panel-showcase).
