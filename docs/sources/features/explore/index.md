...
> Explore is only available in smartEMS 6.0 and above.

## Introduction

One of the major new features of smartEMS 6.0 is the new query-focused Explore workflow for troubleshooting and/or for data exploration.
