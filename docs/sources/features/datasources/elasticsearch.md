...
# Using Elasticsearch in smartEMS

smartEMS ships with advanced support for Elasticsearch. You can do many types of simple or complex Elasticsearch queries to
...
options are enabled, smartEMS converts the labels from plain text to a lucene compatible condition.
...
queries via the Dashboard menu / Annotations view. smartEMS can query any Elasticsearch index
