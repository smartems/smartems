...
# Using OpenTSDB in smartEMS

smartEMS ships with advanced support for OpenTSDB.
...
smartEMS's OpenTSDB data source supports template variable queries. This means you can create template variables
