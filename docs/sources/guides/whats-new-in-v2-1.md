+++
title = "What's New in smartEMS v2.1"
description = "Feature and improvement highlights for smartEMS v2.1"
keywords = ["smartems", "new", "documentation", "2.1"]
type = "docs"
+++

# What's new in smartEMS v2.1
smartEMS 2.1 brings improvements in three core areas: dashboarding, authentication, and data sources.
As with every smartEMS release, there is a whole slew of new features, enhancements, and bug fixes.

## More Dynamic Dashboards
The Templating system is one of the most powerful and well-used features of smartEMS.
...
smartEMS can now index Dashboards saved locally as JSON from a given directory. These file based dashboards
...
### LDAP support
This highly requested feature now allows your smartEMS users to login with their LDAP credentials.
You can also specify mappings between LDAP group memberships and smartEMS Organization user roles.

### Basic Auth Support
You can now authenticate against the smartEMS API utilizing a simple username and password with basic HTTP authentication.
...
There is a new User role available in this version of smartEMS: “Read-only Editor”. This role behaves just
like the Viewer role does in smartEMS 2.0.  That is you can edit graphs and queries but not save dashboards.
The Viewer role has been modified in smartEMS 2.1 so that users assigned this role can no longer edit panels.
...
smartEMS 2.1 now comes with full support for InfluxDB 0.9. There is a new query editor designed from scratch
...
smartEMS OpenTSDB data source now supports template variable values queries. This means you can create
...
The Cassandra backed time series database KairosDB is now supported in smartEMS out of the box. Thank you to
...
smartEMS 2.1 gives you even more flexibility customizing how individual panels render.
