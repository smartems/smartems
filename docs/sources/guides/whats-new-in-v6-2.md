...
To mitigate the risk of [Clickjacking](https://www.owasp.org/index.php/Clickjacking), embedding smartEMS is no longer allowed per default.
...
smartEMS v6.2 ships with official support for Elasticsearch v7, see [Using Elasticsearch in smartEMS](/features/datasources/elasticsearch/#elasticsearch-version) for more information.

## Bar Gauge Panel

smartEMS v6.2 ships with a new exciting panel! This new panel, named Bar Gauge, is very similar to the current
...
smartEMS will not issue any data queries for panels that are not visible. This will greatly reduce the load
...
other panels look strange and have bad vertical centering. In v6.2 smartEMS will allow panel content (visualizations)
