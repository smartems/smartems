...
how many data points are fetched, etc. The time series aggregations are calculated by smartEMS after aggregation is performed
...
If you have Elasticsearch 2.x and smartEMS 2.6 or above then you can use pipeline metric aggregations like
