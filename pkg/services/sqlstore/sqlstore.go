...
import (
	...
	"github.com/smartems/smartems/pkg/services/sqlstore/migrations"
	"github.com/smartems/smartems/pkg/services/sqlstore/migrator"
	"github.com/smartems/smartems/pkg/services/sqlstore/sqlutil"
	"github.com/smartems/smartems/pkg/setting"
	_ "github.com/smartems/smartems/pkg/tsdb/mssql"
...
func InitTestDB(t ITestDB) *SqlStore {
	...
	if db, present := os.LookupEnv("SMARTEMS_TEST_DB"); present {
		dbType = db
	}
