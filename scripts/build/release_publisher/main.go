...
func main() {
	...
	flag.StringVar(&whatsNewURL, "wn", "", "What's new url (ex: --wn http://docs.smartems.org/guides/whats-new-in-v5-2/)")
	flag.StringVar(&releaseNotesURL, "rn", "", "Grafana version (ex: --rn https://community.smartems.com/t/release-notes-v5-2-x/7894)")
	...
	if len(os.Args) == 1 {
		...
		fmt.Println("example: go run publisher.go main.go --version v5.2.0-beta2 --wn http://docs.smartems.org/guides/whats-new-in-v5-2/ --rn https://community.smartems.com/t/release-notes-v5-2-x/7894 --apikey ASDF123 --dry-run --enterprise")
		os.Exit(1)
	}
	...
	archiveProviderRoot := "https://dl.smartems.com"
	buildArtifacts := completeBuildArtifactConfigurations

	if enterprise {
		product = "smartems-enterprise"
