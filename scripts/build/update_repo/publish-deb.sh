...
RELEASE_TYPE="${1:-}"
GCP_DB_BUCKET="${2:-smartems-aptly-db}"
...
gsutil -m rsync -r /deb-repo/repo/smartems/pool "gs://$GCP_REPO_BUCKET/$RELEASE_TYPE/deb/pool"

gsutil -m rsync -r -d /deb-repo/repo/smartems "gs://$GCP_REPO_BUCKET/$RELEASE_TYPE/deb"
